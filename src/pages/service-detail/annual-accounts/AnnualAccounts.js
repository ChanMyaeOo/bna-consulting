    ...
    return (
        ...
        <div className={classes.serviceContainer}>
            ...
            <div className={classes.serviceContent}>
                ...
                <p>Regardless of the type of company you have, whether you are an LLP, a limited company partnership, or a sole trader, you need to ensure that you prepare a set of annual accounts to fulfil your legal obligations. In order for this to be done properly, most London businesses entrust their accounting needs to a reliable local accounting firm to get everything finalised and sorter properly while keeping communication all the way. BNA Consulting is a professional and flexible accounting firm located in London, equipped with experience and knowledge, ready to take on your annual accounts all while offering reliable advice along the way, with the additional support of English and Russian speaking accountants in the heart of London.</p>
                <br/>
                <h4>The Importance of Your Annual Accounts</h4>
                <p>The sole purpose of an annual set of accounts is to summarise the financial flow of the company and to ascertain how much your company owes to HMRC. With BNA Consulting experts, your annual accounts will tell you exactly how your business is performing in the given timeframe and we will highlight the areas of optimum performance for you. With BNA Consulting you will receive a comprehensive and accurate set of accounts that are always going to be of more value to the shareholders, directors, investors and banks.</p>
                <br />
                <p>Our experts will also bring to light anything that might need a bit more attention as we are of the opinion that a well-prepared set of yearly accounts will showcase your business image in a positive and professional manner. BNA Consulting is there to set you apart from other businesses and allow you a much stronger negotiation position with the support of our English and Russian speaking experts.</p>
                <br />
                <p>BNA Consulting has dealt with many cases where companies attempt to complete their own accounts in order to cut costs, however more often than not this can easily lead to mistakes and it may end up costing your business considerably more. This is why you can trust BNA Consulting to handle your accounts and having them ready to hand in for signing and filing at the Companies House.</p>
