    ...
    return (
        ...
        <div className={classes.serviceContainer}>
            ...
            <div className={classes.serviceContent}>
                <h3>VAT</h3>
                <p>We at BNA Consulting pride ourselves on our responsiveness and we always ensure that our advice on everything VAT related will be tailored to your situation and that we will be able to provide it at any time you may need our services. We understand that modern business is under pressure of countless rules and regulations which have to be strictly followed in order to achieve a return of their VAT.</p>
                <br/>
